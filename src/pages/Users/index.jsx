...
const GetAllUsers = () => {
    ...
    return (
        <div className='bg-white h-[100%] w-[100%] -z-[5] p-[2.5rem]'>
            <div className='flex flex-col justify-start items-center w-[100%] pl-[10px] pr-[10px] pb-[4rem] bg-tertiary-light rounded-[1rem]'>
                <div className='w-[100%]'>
                    <h2 className='text-[4rem]'>Users</h2>
                </div>
                <div className='bg-white w-[100%] h-[100%] flex justify-center items-center mt-[4rem] pt-[1.5rem] pb-[1.5rem] rounded-[1rem]'>
