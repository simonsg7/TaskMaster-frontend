        ...
        <>
            <form onSubmit={handleSubmit(onSubmit)} className='flex flex-col items-center justify-center'>
                <div className='p-2 flex'>
                    <div>
                        <InputText {...register("name", {required: true})} type="text" className="h-[2.4rem] w-[12rem] p-[0.3rem] border border-blue-300 hover:bg-bgInput mr-4" placeholder="Task Name"  />
                        <br />
